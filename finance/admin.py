...
class DailyClosingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("date", "order_count", "notes")}),
        ("Vendas", {"fields": ("cash_sales", "pix_sales", "card_sales")}),
        (
            "Calculados",
            {"fields": ("display_total_sales", "display_average_ticket"), "classes": ("collapse",)},
        ),
...
class ExpenseAdmin(admin.ModelAdmin):
    ...
    list_display = ("date", "category", "display_amount", "description_preview", "created_at")
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("date", "category", "amount")}),
