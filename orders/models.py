...
class Product(models.Model):
    ...
    description = models.TextField(blank=True, verbose_name='Descrição', help_text='Composição do produto')
...
class ProductVariant(models.Model):
    """
    Variação de produto por tamanho e preço. Armazena o preço atual e o limite de adicionais incluídos.
...
class Order(models.Model):
    ...
    def __str__(self):
        return f"Pedido #{self.pk} — Comanda {self.comanda_number} ({self.order_date.strftime('%d/%m/%Y')})"
