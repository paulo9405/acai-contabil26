...
ACAIS_PRONTOS = [
    ('01 Açaí Puro', 1, {
        '300 ml': '16.00', '500 ml': '18.00', '700 ml': '24.00',
        '1 litro': '32.00', '1,5 litro': '50.00', '2 litros': '62.00',
    }),
    ('02 Açaí Puro c/ Cupuaçu', 2, {
        '300 ml': '18.00', '500 ml': '22.00', '700 ml': '26.00',
        '1 litro': '36.00', '1,5 litro': '52.00', '2 litros': '64.00',
    }),
    ('03 Açaí Gotas de Chocolate', 3, {
        '300 ml': '20.00', '500 ml': '25.00', '700 ml': '28.00',
        '1 litro': '38.00', '1,5 litro': '54.00', '2 litros': '64.00',
    }),
    ('04 Açaí Ninho', 4, {
        '300 ml': '18.00', '500 ml': '22.00', '700 ml': '26.00',
        '1 litro': '36.00', '1,5 litro': '52.00', '2 litros': '64.00',
    }),
    ('05 Açaí Ninho c/ Cupuaçu', 5, {
        '300 ml': '20.00', '500 ml': '26.00', '700 ml': '32.00',
        '1 litro': '40.00', '1,5 litro': '54.00', '2 litros': '56.00',
    }),
    ('06 Açaí Maltine', 6, {
        '300 ml': '18.00', '500 ml': '24.00', '700 ml': '28.00',
        '1 litro': '37.00', '1,5 litro': '53.00', '2 litros': '62.00',
    }),
    ('07 Açaí Kids', 7, {
        '300 ml': '19.00', '500 ml': '25.00', '700 ml': '29.00',
        '1 litro': '40.00', '1,5 litro': '54.00', '2 litros': '62.00',
    }),
    ('08 Açaí Frutas', 8, {
        '300 ml': '20.00', '500 ml': '27.00', '700 ml': '30.00',
        '1 litro': '39.00', '1,5 litro': '55.00', '2 litros': '63.00',
    }),
    ('09 Açaí Nutella', 9, {
        '300 ml': '22.00', '500 ml': '30.00', '700 ml': '36.00',
        '1 litro': '50.00', '1,5 litro': '59.00', '2 litros': '68.00',
    }),
    ('10 Combo Família', 10, {
        '1,5 litro': '60.00', '2 litros': '72.00',
    }),
    ('11 Açaí Zero', 11, {
        '300 ml': '18.00', '500 ml': '24.00', '700 ml': '28.00',
        '1 litro': '39.50',
    ...
    ('12 Açaí Gourmet', 12, {
        '300 ml': '21.00', '500 ml': '29.00', '700 ml': '34.00',
        '1 litro': '49.00', '1,5 litro': '54.00', '2 litros': '65.00',
    }),
    ('13 Açaí Oreo', 13, {
        '300 ml': '19.00', '500 ml': '26.00', '700 ml': '30.00',
        '1 litro': '48.00', '1,5 litro': '53.00', '2 litros': '62.00',
    }),
]
    ...
    def _load_sizes(self, dry_run, counters):
        ...
        for data in SIZES:
            self._upsert(
                ...
                defaults={'volume_ml': data['volume_ml'], 'sort_order': data['sort_order'], 'active': True},
                dry_run=dry_run,
                counters=counters,
                label=data['name'],
            )
        ...
        for size_name, price, limit in MONTE_ACAI_VARIANTS:
            ...
            if not created:
                changed = (
                    ...
                    or variant.included_addons_limit != limit
                )
                if changed:
                    variant.price = Decimal(price)
