...
class ProductCategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("name", "kind", "active")}),
...
class SizeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("name", "volume_ml", "active")}),
        ("Exibição", {"fields": ("sort_order",)}),
    )
...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("name", "category", "product_type", "active")}),
...
class ProductVariantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("product", "size", "price", "active")}),
        (
...
class AddonAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informações Básicas", {"fields": ("name", "price", "active")}),
        (
            "Monte seu Açaí",
            {
                "fields": ("is_free_option",),
                "description": "Marque se este adicional pode ser incluído gratuitamente"
                " no Monte seu Açaí.",
            },
        ),
        ("Exibição", {"fields": ("sort_order",)}),
