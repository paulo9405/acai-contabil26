...
class TestMixedOrder:
    ...
    def test_mixed_order_catalog_item_has_addons_manual_does_not(
        self, user, variant, order_date, order_time
    ):
...
class TestItemTypeDefault:
    def test_catalog_is_default_when_item_type_not_specified(
        self, user, variant, order_date, order_time
    ):
